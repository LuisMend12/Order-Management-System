...
var file_orders_v1_orders_proto_goTypes = []any{
	...
	(*GetOrdersRequest)(nil),    // 4: orders.v1.GetOrdersRequest
	(*GetOrdersResponse)(nil),   // 5: orders.v1.GetOrdersResponse
}
var file_orders_v1_orders_proto_depIdxs = []int32{
	0, // 0: orders.v1.GetOrdersResponse.orders:type_name -> orders.v1.Order
	1, // 1: orders.v1.OrderService.CreateOrder:input_type -> orders.v1.CreateOrderRequest
